        ...
        <div class="box form-box">
            <?php 
               if(isset($_POST['submit'])){
                ...
                $edit_query = mysqli_query($con,"UPDATE users SET Username='$username', Email='$email', Age='$age', gambar='$newFileName' WHERE Id=$id ") or die("error occurred");
            ...
            ?>
            <header><b>Change Profile</b></header>
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="file" name="gambar" id="age" autocomplete="off" required>
